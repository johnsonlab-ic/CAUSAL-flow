...
parser$add_argument("--pph4_cutoff_mr",help="clumped file path")
parser$add_argument("--eqtl_fdr_cutoff",help="clumped file path")
...
clump=args$clumped
pph4_cutoff=as.numeric(args$pph4_cutoff_mr)
eqtl_fdr_cutoff=as.numeric(args$eqtl_fdr_cutoff)
